...
For a maintained fork of this project that implements features such as JSON configuration, see [**get-got/discord-downloader-go**](https://github.com/get-got/discord-downloader-go)
